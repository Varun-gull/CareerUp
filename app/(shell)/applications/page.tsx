    ...
    <>
      <main className="page-shell">
        <PageHero
          ...
          actions={
            <Link href="/applications/new" className="inline-flex min-h-10 items-center gap-2 rounded-2xl bg-white px-4 text-sm font-black text-[#2A6384] shadow-sm transition hover:bg-[#E1EFEB]">
