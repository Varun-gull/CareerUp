    ...
    <>
      <main className="page-shell">
        <section className="card overflow-hidden">
          <div className="border-b border-white/10 bg-[#7A5438] px-6 py-10 text-white">
            <div className="flex flex-wrap items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-3xl border border-white/15 bg-white text-2xl font-bold text-[#7A5438] shadow-glow">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#E2D2BF]">Student profile</p>
          ...
          <div className="grid gap-6 p-6 lg:grid-cols-[1fr_360px]">
            ...
            <aside className="space-y-4">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white/85 p-4">
                <div className="rounded-2xl border border-[#B8A99A]/35 bg-white p-4">
