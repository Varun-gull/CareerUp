          ...
          <>
            ...
            <form className="card mt-6 grid gap-4 p-5 md:grid-cols-[1fr_220px_auto]">
              <label className="grid gap-2 text-sm font-bold text-slate-700">
                Search
                <input name="q" defaultValue={query} className="rounded-lg border border-slate-200 px-4 py-3 outline-none focus:border-[#567C8D]" placeholder="Company, role, or location" />
              </label>
              <label className="grid gap-2 text-sm font-bold text-slate-700">
                Status
                <select name="status" defaultValue={statusFilter} className="rounded-lg border border-slate-200 bg-white px-4 py-3 outline-none focus:border-[#567C8D]">
