                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            {conversation.unreadCount > 0 && (
                              <span className="flex h-5 min-w-5 items-center justify-center rounded-full bg-sky px-1 text-[10px] font-black text-white">
                      ...
                      <div className={`max-w-[80%] rounded-3xl border p-4 ${
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {message.unread && !outbound && (
                            <span className="rounded-full bg-sky px-2 py-0.5 text-[10px] font-black text-white">Unread</span>
                          )}
                        </div>
