...
export default async function HomePage() {
  ...
  return (
    <main className="page-shell grid min-h-screen place-items-center">
      <section className="grid w-full max-w-6xl overflow-hidden rounded-[2rem] border border-slate-700 bg-slate-950/80 shadow-strong backdrop-blur-xl lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="grid content-center gap-4 bg-slate-900/60 px-6 py-10 sm:px-10 lg:px-12">
          {[
            ...
            <div key={title as string} className="rounded-3xl border border-slate-700 bg-slate-950/60 p-5 shadow-sm">
