  ...
  return (
    <>
      ...
      <main className="page-shell">
        <Link href="/postings" className="inline-flex items-center text-sm font-black text-[#2F4156] hover:text-[#2F4156]">
        ...
        <section className="mt-5 grid gap-5 lg:grid-cols-[1fr_360px]">
          <div className="card p-6">
            ...
            {!resume.resumeText ? (
              <div className="mt-6 rounded-lg border border-blue-100 bg-[#C8D9E6]/40 p-5">
                <h2 className="font-black text-[#2F4156]">Upload your resume first</h2>
          ...
          <aside className="space-y-4">
            <div className="card p-5">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-[#C8D9E6]/40 text-[#2F4156]">
                  <Sparkles size={22} />
                </div>
                <div>
              ...
              <p className="mt-4 text-sm font-black text-[#2F4156]">{company}</p>
              {tags.length > 0 && (
