      ...
      <main className="page-shell">
        ...
        <section className="mt-8 grid gap-4 md:grid-cols-3">
          <div className="card p-5">
            <Sparkles size={22} className="text-[#567C8D]" />
          ...
          <div className="card p-5">
            <Gift size={22} className="text-[#567C8D]" />
          ...
          <div className="card p-5">
            <Trophy size={22} className="text-[#567C8D]" />
            ...
            return (
              <article key={reward.id} className="card p-5">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    <p className="text-sm font-black text-[#567C8D]">{reward.category}</p>
