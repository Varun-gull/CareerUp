          ...
          <section className="card mt-6 overflow-hidden">
            <div className="bg-ink px-6 py-10 text-white">
              <div className="flex flex-wrap items-center justify-between gap-5">
                ...
                {isOwnProfile ? (
                  <Link href="/profile" className="inline-flex min-h-11 items-center justify-center rounded-lg border border-white/20 px-5 font-bold hover:border-accent">
                    Edit profile
                  </Link>
                ) : friendship ? (
                  ...
                  <form action={sendFriendRequestById}>
                    ...
                    <button className="inline-flex min-h-11 items-center justify-center rounded-lg bg-brand px-5 font-bold text-white shadow-lg shadow-brand/20 hover:bg-brand-dark">
                      <UserPlus className="mr-2" size={18} /> Add friend
                    </button>
                  </form>
                ) : (
                  <Link href={`/login?message=${encodeURIComponent("Log in to add this profile as a friend.")}`} className="inline-flex min-h-11 items-center justify-center rounded-lg bg-brand px-5 font-bold text-white shadow-lg shadow-brand/20 hover:bg-brand-dark">
                    Log in to add
                  </Link>
                )}
              </div>
