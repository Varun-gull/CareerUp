...
const EVENT_TYPE_COLORS: Record<string, string> = {
  ...
  custom: "bg-lavender/50 text-brand border-lavender",
};
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <button
              onClick={() => navigate(-1)}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 hover:border-accent hover:text-brand transition-colors"
            >
              <ChevronLeft size={18} />
            </button>
            ...
            <button
              ...
              className="ml-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-600 hover:border-accent hover:text-brand transition-colors"
            >
              Today
            </button>
          </div>
            ...
            return (
              <div
                ...
                className={clsx(
                  ...
                  isActive ? "border-blue-400 bg-lavender/50" : "border-slate-100 bg-white/70",
