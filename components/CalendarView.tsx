...
const EVENT_TYPE_COLORS: Record<string, string> = {
  ...
  custom: "bg-[#C8D9E6]/40 text-[#2F4156] border-[#b0cdd9]",
};
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <p className="truncate text-sm font-black text-[#567C8D]">{app.company}</p>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <button
              onClick={() => navigate(-1)}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 hover:border-[#8AAEC0] hover:text-[#2F4156] transition-colors"
            >
              <ChevronLeft size={18} />
            </button>
            ...
            <button
              ...
              className="ml-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-600 hover:border-[#8AAEC0] hover:text-[#2F4156] transition-colors"
            >
              Today
            </button>
          </div>
          ...
          <div className="flex rounded-lg border border-slate-200 bg-white p-1">
            <button
              ...
              className={clsx(
                ...
                view === "month" ? "bg-[#567C8D] text-white" : "text-slate-600 hover:text-[#2F4156]"
              )}
            >
            ...
            <button
              ...
              className={clsx(
                "flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-bold transition-colors",
                view === "week" ? "bg-[#567C8D] text-white" : "text-slate-600 hover:text-[#2F4156]"
              )}
            >
              <List size={14} /> Week
            </button>
            ...
            return (
              <div
                ...
                className={clsx(
                  ...
                  isActive ? "border-blue-400 bg-[#C8D9E6]/40" : "border-slate-100 bg-white/70",
                  !isCurrentMonth && "opacity-40"
                )}
              >
                <span className={clsx(
                  "inline-flex h-6 w-6 items-center justify-center rounded-full text-xs font-bold",
                  isToday ? "bg-[#567C8D] text-white" : "text-slate-500"
                )}>
                  {day.getDate()}
                </span>
