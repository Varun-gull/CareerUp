...
const TIER_COLORS = [
  "",
  "text-[#231942] bg-[#EFE9F4] ring-[#7E739F]/30",
  ...
  return (
    <article className={clsx("card p-5 transition hover:-translate-y-1 hover:shadow-strong", challenge.completed && "ring-2 ring-emerald-400/60")}>
      <div className="flex items-start justify-between gap-4">
        <div className={clsx("flex h-11 w-11 items-center justify-center rounded-2xl shadow-sm", challenge.completed ? "bg-emerald-500" : "bg-[#231942] text-white")}>
          {challenge.completed
        ...
        <div className="flex items-center gap-2">
          ...
          {challenge.completed ? (
            ...
            <span className="rounded-full bg-[#EFE9F4] px-3 py-1 text-xs font-bold text-[#231942] ring-1 ring-[#7E739F]/30">+{challenge.xp} XP</span>
          )}
        </div>
      </div>
