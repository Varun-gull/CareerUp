  ...
  return (
    <article className="card p-5">
      <div className="flex items-start justify-between gap-4">
        <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-[#567C8D] text-white">
      ...
      <div className="mt-5">
        ...
        <div className="h-2 overflow-hidden rounded-full bg-slate-100">
          <div
            className={clsx("h-full rounded-full", challenge.completed ? "bg-emerald-500" : "bg-[#567C8D]")}
            style={{ width: `${percent}%` }}
          />
        </div>
      </div>
