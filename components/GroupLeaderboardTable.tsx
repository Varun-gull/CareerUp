...
export function GroupLeaderboardTable({ groups }: { groups: GroupLeaderboardRow[] }) {
  if (groups.length === 0) {
    return (
      <div className="card p-8 text-center">
        ...
        <h2 className="mt-4 text-2xl font-black text-ink">No groups yet</h2>
  ...
  return (
    <div className="card overflow-hidden">
      <div className="grid grid-cols-[56px_1fr_130px] gap-4 border-b border-slate-200 bg-white px-5 py-4 text-xs font-black uppercase text-slate-700 sm:grid-cols-[56px_1fr_140px_140px]">
        <span>#</span>
        <span>Group</span>
        <span>Total XP</span>
