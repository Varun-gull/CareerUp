        ...
        <div className="mt-5 space-y-4">
          <label className="grid gap-1.5 text-sm font-bold text-slate-700">
            ...
            <input
              ...
              className="rounded-lg border border-slate-200 px-4 py-3 outline-none focus:border-[#567C8D]"
            />
          </label>
          <label className="grid gap-1.5 text-sm font-bold text-slate-700">
          ...
          <label className="grid gap-1.5 text-sm font-bold text-slate-700">
            ...
            <textarea
              ...
              className="resize-none rounded-lg border border-slate-200 px-4 py-3 text-sm outline-none focus:border-[#567C8D]"
            />
          </label>
        </div>
