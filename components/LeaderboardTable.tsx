  ...
  if (sorted.length === 0) {
    return (
      <div className="card p-8 text-center">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-lg bg-lavender/50 text-brand">
          <UserPlus size={22} />
        </div>
        ...
        >
          ...
          <div>
            <p className="font-black text-ink">
              {user.name}
              {currentUserId === user.id && <span className="ml-2 rounded-full bg-lavender/50 px-2 py-0.5 text-xs font-black text-brand">You</span>}
            </p>
