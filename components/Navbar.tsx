...
function CalendarWidget() {
  ...
  return (
    <Link
      ...
      aria-label="Calendar"
    >
      <span className="absolute top-0 left-0 right-0 h-[16px] bg-[#6b3fa0] flex items-center justify-center">
...
export async function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-purple-100 bg-[#f5f3f9]/95 backdrop-blur">
      <nav className="page-shell flex items-center justify-between gap-4 py-4">
        <Link href="/dashboard" className="flex items-center gap-3 font-black text-ink">
          <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#6b3fa0] text-white">
