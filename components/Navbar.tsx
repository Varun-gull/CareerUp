...
function MessageButton({ unreadMessages }: { unreadMessages: number }) {
  return (
    ...
    >
      <Mail size={19} />
      {unreadMessages > 0 && (
        <span className="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-sky px-1 text-[10px] font-black text-white ring-2 ring-navy">
