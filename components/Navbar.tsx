...
function CalendarWidget() {
  ...
  return (
    <Link
      ...
      aria-label="Calendar"
    >
      <span className="absolute top-0 left-0 right-0 h-[16px] bg-brand flex items-center justify-center">
...
export async function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-accent/40 bg-lavender/95 backdrop-blur">
