  ...
  return (
    <form onSubmit={handleSubmit} className="card mt-8 grid gap-4 p-5 lg:grid-cols-[1.15fr_1fr_0.75fr_0.75fr_auto]">
      ...
      <label className="grid gap-2 text-sm font-bold text-slate-700">
        Role or keyword
        <input name="q" list="role-keyword-examples" defaultValue={defaultQuery} className="rounded-lg border border-slate-200 px-4 py-3 outline-none focus:border-blue-500" placeholder="Data science intern" />
      ...
      <label className="grid gap-2 text-sm font-bold text-slate-700">
        Location
        <input name="location" list="location-examples" defaultValue={defaultLocation} className="rounded-lg border border-slate-200 px-4 py-3 outline-none focus:border-blue-500" placeholder={locationPlaceholder} />
