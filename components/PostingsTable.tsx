          ...
          return (
            <article key={posting.id} className="p-4">
              <div className="flex items-start gap-3">
                <span className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-sky text-xs font-black text-white">{index + 1}</span>
                  ...
                  <button
                    ...
                    className={
                      saved
                        ...
                        : "inline-flex min-h-10 w-full items-center justify-center rounded-2xl bg-sky px-3 text-sm font-black text-white shadow-sm transition hover:bg-brand"
                    }
                  >
                    ...
                    <button
                      ...
                      className={
                        saved
                          ...
                          : "inline-flex min-h-9 w-full items-center justify-center rounded-2xl bg-sky px-2 text-xs font-black text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-brand"
                      }
                    >
