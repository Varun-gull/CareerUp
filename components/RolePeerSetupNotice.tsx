...
export function RolePeerSetupNotice({ status }: { status: RolePeerFeatureStatus }) {
  ...
  return (
    <div className="mt-5 rounded-3xl border border-sky/20 bg-sky/10 p-4 text-sm font-bold text-sky-600 shadow-soft backdrop-blur">
      ...
      <Link href="/messages" className="mt-3 inline-flex text-sky-600 underline underline-offset-4">
