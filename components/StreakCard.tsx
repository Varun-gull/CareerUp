          ...
          {freeReviveUsed && (
            <form action={unlockStreakRevive} className="mt-3">
              <button
                ...
                className="w-full rounded-xl bg-sky px-3 py-2 text-sm font-black text-white transition hover:bg-brand disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-500"
              >
