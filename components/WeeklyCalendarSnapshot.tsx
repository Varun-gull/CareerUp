...
function eventTone(type: CalendarEvent["eventType"]) {
  ...
  if (type === "deadline") return "border-[#7E739F]/35 bg-[#EFE9F4]/80 text-[#231942]";
...
export function WeeklyCalendarSnapshot({ events }: { events: CalendarEvent[] }) {
  ...
  return (
    <section className="card p-5">
            ...
            <div
              ...
              className={`group relative min-h-24 rounded-2xl border p-2 text-left transition ${
                isToday
                  ...
                  : day.inMonth
                    ? "border-[#7E739F]/30 bg-[#EFE9F4]/60 hover:border-[#231942]/40 hover:bg-white/80"
                    : "border-slate-200/70 bg-white/35 text-slate-400"
              }`}
            >
              <div className="flex items-center justify-between gap-2">
                <p className={isToday ? "text-sm font-black text-sky-600" : day.inMonth ? "text-sm font-bold text-[#231942]" : "text-sm font-bold text-slate-400"}>
                  {day.date.getDate()}
                </p>
      ...
      <div className="mt-5 rounded-2xl border border-[#7E739F]/30 bg-[#EFE9F4]/60 p-4">
